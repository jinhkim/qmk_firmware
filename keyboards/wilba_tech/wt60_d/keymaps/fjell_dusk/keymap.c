...
[0] = LAYOUT_all(
	...
	KC_LSFT, KC_NO,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_TRNS,
...
[1] = LAYOUT_all(
	...
	KC_TRNS, KC_MPRV, KC_MPLY,   KC_MNXT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_UP,  KC_TRNS, KC_PSCR, KC_PGUP, KC_PGDN, KC_TRNS,
	KC_CAPS, KC_LEFT, KC_VOLD, KC_VOLU, KC_MUTE, KC_TRNS, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_INS, KC_DEL, KC_TRNS,
