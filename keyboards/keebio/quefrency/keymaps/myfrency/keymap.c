...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_63(
    ...
    KC_LCTL, KC_LGUI, KC_LALT,          KC_SPC,           MO(_FN1),       KC_SPC, KC_RALT, MO(_FN1), MO(_FN2), KC_RCTL
  ),
  ...
  [_FN2] = LAYOUT_63(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    KC_BRID, _______, KC_BRIU,          _______,          _______,        _______, _______, _______, _______, _______
  )
